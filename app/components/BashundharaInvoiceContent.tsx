...
export default function BashundharaInvoiceContent({
  ...
  const consigneeName =
    shippingData?.Shipping_Address_Name || rawQuotationData?.Shipping_Address_Name || 'Bashundhara Paper Mills Limited (Unit-03)'
  ...
  const consigneeCountry = shippingData?.Shipping_Country || rawQuotationData?.Shipping_Country || 'Bangladesh'
              ...
              <tbody>
                ...
                <tr>
                  <td style={{ width: '53%', verticalAlign: 'top', border: '1px solid #000', padding: '8px' }}>
                    ...
                    <div style={{ fontWeight: 'bold', fontSize: '12px' }}>{consigneeName}</div>
                    <div style={{ fontSize: '11px', lineHeight: 1.15 }}>{consigneeAddress}</div>
                      ...
                      <tbody>
                        <tr>
                          <td style={{ width: '60%', border: '1px solid #000', padding: '4px 6px', fontWeight: 'bold' }}>
                            HS Code: {rawQuotationData?.HS_Code || '7314.1410'}
                          </td>
